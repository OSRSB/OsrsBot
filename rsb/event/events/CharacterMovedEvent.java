package net.runelite.client.rsb.event.events;

import net.runelite.client.rsb.methods.MethodContext;
import net.runelite.client.rsb.event.EventMulticaster;
...
public class CharacterMovedEvent extends RSEvent {
	...
	private net.runelite.client.rsb.wrappers.RSCharacter wrapped;
	...
	public net.runelite.client.rsb.wrappers.RSCharacter getCharacter() {
		if (wrapped == null) {
			if (character instanceof net.runelite.api.NPC) {
				final net.runelite.api.NPC npc = (net.runelite.api.NPC) character;
				wrapped = new net.runelite.client.rsb.wrappers.RSNPC(ctx, npc);
				...
				wrapped = new net.runelite.client.rsb.wrappers.RSPlayer(ctx, player);
			}
		}
		return wrapped;
	}

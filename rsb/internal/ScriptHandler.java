...
import net.runelite.client.rsb.script.randoms.LoginBot;

import java.util.*;

public class ScriptHandler {

	private final ArrayList<net.runelite.client.rsb.script.Random> randoms = new ArrayList<net.runelite.client.rsb.script.Random>();
	...
	public void init() {
		...
		for (net.runelite.client.rsb.script.Random r : randoms) {
	...
	public Collection<net.runelite.client.rsb.script.Random> getRandoms() {
		return randoms;
	}

...
import net.runelite.client.rsb.internal.MouseHandler;
...
public class Mouse extends MethodProvider {
	...
	public Point getLocation() {
		return new Point(methods.virtualMouse.getClientX(), methods.virtualMouse.getClientY());
				//((net.runelite.client.rsb.internal.input.Mouse) methods.clientUI.getMouseManager().getMouseListeners().get(3)).getX(),
				//((net.runelite.client.rsb.internal.input.Mouse) methods.clientUI.getMouseManager().getMouseListeners().get(3)).getY());
	}
	...
	public Point getPressLocation() {
		return new Point(methods.virtualMouse.getClientPressX(), methods.virtualMouse.getClientPressY());
			//	((((net.runelite.client.rsb.internal.input.Mouse) methods.clientUI.getMouseManager().getMouseListeners().get(3)).getPressX())),
			//	((net.runelite.client.rsb.internal.input.Mouse) methods.clientUI.getMouseManager().getMouseListeners().get(3)).getPressY());
	}
	...
	public long getPressTime() {
		return methods.virtualMouse.getClientPressTime();
				//((net.runelite.client.rsb.internal.input.Mouse) methods.clientUI.getMouseManager().getMouseListeners().get(3)).getPressTime();
	}
	...
	public boolean isPresent() {
		return methods.virtualMouse.isClientPresent();
				...
				//((net.runelite.client.rsb.internal.input.Mouse) methods.clientUI.getMouseManager().getMouseListeners().get(3)).isPresent();
	}

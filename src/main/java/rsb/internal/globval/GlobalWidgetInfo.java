...
import static rsb.internal.globval.GlobalWidgetId.INTERFACE_MINIMAP_PRAYER_ORB_LABEL;
...
public enum GlobalWidgetInfo {
    ...
    MINIMAP_HEALTH_ORB_TEXT(INTERFACE_MINIMAP_HEALTH_ORB, INTERFACE_MINIMAP_HEALTH_ORB_LABEL),
    MINIMAP_PRAYER_ORB_TEXT(INTERFACE_MINIMAP_PRAYER_ORB, INTERFACE_MINIMAP_PRAYER_ORB_LABEL),
    MINIMAP_RUN_ORB_TEXT(INTERFACE_MINIMAP_RUN_ORB, INTERFACE_MINIMAP_RUN_ORB_LABEL),
    MINIMAP_SPEC_ORB_TEXT(INTERFACE_MINIMAP_SPEC_ORB, INTERFACE_MINIMAP_SPEC_ORB_LABEL),
    MINIMAP_QUICK_PRAYER_ORB_SPRITE(INTERFACE_MINIMAP_PRAYER_ORB, INTERFACE_MINIMAP_PRAYER_ORB_SPRITE),
    //[MINIMAP]
